...
| Note: You can #FIXME tags in [[file:d-setup.org][d-setup.org]] where you should edit it accordingly to your USERNAME and HOSTNAME.       |
|--------------------------------------------------------------------------------------------------------------------|
| I have tried to comment few things to make it as a info, you can ask/create issue regarding this, don't hold back. |
