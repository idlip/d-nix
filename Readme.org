...
- Management of NixOS and Emacs config in literate org file - [[file:d-setup.org][d-setup.org]].
...
[2026-05-01 Fri] This has become outdated screenshot. As on this day, I use [[https://codeberg.org/ezemtsov/ewm/][EWM (emacs wayland manager)]] (primary), [[https://github.com/mangowm/mango/][mangowm]] & [[https://github.com/yalTeR/niri][Niri]] sometimes, all 3 are used with [[https://noctalia.dev/][Noctalia shell]] and [[https://github.com/glide-browser/glide/][Glide browser]] at its core.

* 🌟 Utilities that are Best (I use)!
--------------

|---------------------------+----------------------|
| Class                     | Name                 |
|---------------------------+----------------------|
| 🌸 Window Manager         | [[https://codeberg.org/ezemtsov/ewm/][EWM]], [[https://github.com/yalTeR/niri][Niri]], [[https://github.com/mangowm/mango/][Mango]]     |
| 💜 Text Editor            | [[https://www.gnu.org/software/emacs/][Emacs]]                |
| 🎨 Gtk Theme              | [[https://github.com/danth/stylix/][Stylix]]               |
| 🐧 Desktop Shell          | [[https://noctalia.dev/][Noctalia Shell]]       |
|   Font                  | [[https://github.com/subframe7536/maple-font][Maple Mono]], Iosevka  |
| 📔 Pdf Reader             | [[https://github.com/ahrm/sioyek][Sioyek]]               |
| 🎬 Media Player           | [[https://mpv.io][mpv]]                  |
| 🖼️ Image Viewer           | [[https://github.com/artemsen/swayimg][Swayimg]]              |
| 📰 RSS Reader             | [[://www.gnu.org/software/emacs/][emacs]]                |
| 🎶 Music Player           | [[https://www.musicpd.org/][mpd+mpc]]              |
|   Terminal              | [[https://codeberg.org/dnkl/foot][Foot]] or emacs eshell |
| 🚀 Menu/Launcher          | Emacs or [[https://github.com/vicinaehq/vicinae/][Vicinae]]     |
| 🛎️ Notification           | [[https://noctalia.dev/][Noctalia Shell]]       |
...
#+begin_center
If you have reached here, I think you'd like to read more. I have made a static website, you can catch on some stuffs here ==> [[https://idlip.in]]
#+end_center
