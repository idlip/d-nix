      ...
      "monitors": [
        {
          "directory": "/home/dev/d-git/d-wallpapers/walls/",
          "name": "eDP-1",
          "wallpaper": "/home/dev/d-git/d-wallpapers/walls//collected-56.jpg"
        }
      ],
      "randomEnabled": true,
...
#+begin_src conf :noweb-ref niri-config :tangle ~/.config/niri/config.kdl
  ...
  binds {
    ...
    // Bindings should be sensible as in Emacs, and vim (just hjkl)
  	...
  	Mod+D { spawn-sh "vicinae"; }
  	Mod+Shift+D { spawn-sh "noctalia-shell ipc call launcher toggle"; }
    ...
    Mod+C { center-column; }
  	...
  	Mod+Ctrl+P allow-when-locked=true { spawn-sh "noctalia-shell ipc call lockScreen toggle & systemctl suspend"; }
  	Mod+Ctrl+L allow-when-locked=true { spawn-sh "noctalia-shell ipc call lockScreen toggle" ; }
  }
...
- More mails
  #+begin_src emacs-lisp :tangle no
    (use-package gnus :if d/on-foss
      :config (load-file "~/d-sync/feeds/gnews/privmail.el"))
  #+end_src
