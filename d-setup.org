...
- [[#-user-configurations][👤 User Configurations]]
  - [[#i-home][i-home]]
    ...
    - [[#main-body][Main Body]]
      - [[#tangled-file-warning-1][Tangled File Warning]]
      - [[#inherited-sources-1][Inherited Sources]]
      - [[#opening-statement-1][Opening Statement]]
      - [[#shell-configuration][Shell Configuration]]
        - [[#system-shell][System Shell]]
        - [[#sourcessh][Sources.sh]]
      - [[#user-packages][User Packages]]
        - [[#opening-statement-2][Opening Statement]]
        - [[#wayland][Wayland]]
        - [[#media][Media]]
        - [[#cli-tools][cli-tools]]
        - [[#themes][Themes]]
        - [[#browsers][Browsers]]
        - [[#lsp--ide][LSP -IDE]]
        - [[#closing-statement-1][Closing Statement]]
      - [[#package-specific-configs][Package Specific configs]]
        - [[#gtk-theme][Gtk Theme]]
        - [[#aria][Aria]]
        - [[#cli-tools-1][Cli tools]]
        - [[#dunst][Dunst]]
        - [[#foot][Foot]]
        - [[#hyprland][Hyprland]]
        - [[#sway][Sway]]
      ...
      - [[#closing-statement-2][Closing Statement]]
- [[#-additional-files][📂 Additional Files]]
  - [[#first-time-set-up-script][First Time Set Up Script]]
    - [[#install-system-flake][Install System Flake]]
    - [[#copy-first-time-installation-checklist][Copy First Time Installation Checklist]]
...
#+begin_src conf  :tangle (format "%s/hypr/hyprland.conf" (get-named-src-block-contents "my-configs" t))
  ...
  # █▀▄▀█ █ █▀ █▀▀
  # █░▀░█ █ ▄█ █▄▄
  bind = SUPER, RETURN, exec, pgrep emacs && emacsclient -c -e "(multi-vterm)" || footclient
  bind = SUPERSHIFT, RETURN, exec, pgrep emacs && emacsclient -c -e "(multi-vterm-next)" || footclient
