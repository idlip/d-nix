...
#+name: hm-config
#+begin_src nix :gdk/home.nix
{
  home.sessionVariables = {
    PATH = "$PATH:$HOME/d-git/d-bin/bin:$HOME/.local/bin";
    BEMENU_OPTS = "-i -p ' ' --fn 'Code D Ace 16' --nb '#00000090' --ab '#00000090' --bdr '#c6daff' --nf '#ffffff' --af '#ffffff' --hb '#2e8b57' --hf '#000000' --fb '#111111' --ff '#fafad2' --tb '#121212' --tf '#6ae4b9' ";
    VISUAL = "$EDITOR";
