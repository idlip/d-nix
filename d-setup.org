  ...
  #+begin_src nix :tangle gdk/core.nix
{
  ...
  #+end_src
*** COMMENT seatd
- Seat management to run some command without root
- 2024-08-29; Idk if needed or programs.hyprland will get something
  #+name: nixos-core
  #+begin_src nix :tangle gdk/core.nix
{
  systemd.services = {
...
- Dunst to notify and send.
  ...
  #+end_src
**** COMMENT mako
- Another minimal lightweight notification for wayland.
  #+name: hm-config
  #+begin_src nix
{
  services.mako = {
...
*** Launcher
**** bemenu
- The fast and suckless menu/launcher
  #+name: hm-config
  #+begin_src nix :tangle gdk/home.nix
  {
