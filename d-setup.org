...
https://yhetil.org/emacs-devel/CAL6FEzxCFJDxy=7+St8igfGa=N-MBnU==+9VcKyC9MaoWXyfxw@mail.gmail.com/T/#m6ea0ea588940eff4ce4e6e2da7fe636b8202351d
  #+begin_src emacs-lisp
...
**** COMMENT icomplete fido vertical
- It can replace vertico for basic purpose.

  Major cons:
  - Does not work well with completion-at-point or in-region like corfu
    Works fine but breaks in python IDLE
...
- preview the known completions.
  ...
  So if it slows down, why would I use it everytime while typing. Just =C-M-i=
...
**** emacs write anywhere
- Write text in browser or anywhere using emacs.
  #+begin_src emacs-lisp
...
#+begin_src emacs-lisp :tangle ~/.config/emacs/eshell/alias
  ...
  alias ll ls -l $@*
  alias emacs /etc/profiles/per-user/idlip/bin/emacs $@*
  alias .1 cd .. $*
  alias .2 cd ../.. $*
  alias .3 cd ../../.. $*
  alias bc bc -ql $*
...
*** hacker news
- Wonderful organized way to read hacker news threads.
...
#+begin_src conf :tangle ~/.config/niri/config.kdl
  ...
  layout {
    ...
    always-center-single-column
  	...
  	preset-column-widths { proportion 0.25; proportion 0.5; proportion 0.75; proportion 1.0; }
    preset-window-heights { proportion 0.33333; proportion 0.5; proportion 0.66667; }
  ...
  binds {
    ...
    Mod+Ctrl+T {spawn "sh" "-c" "emacsclient -e '(d/write-here)'"; }
...
** center buffer document olivetti mode
- Alternative to olivetti in minimal way
  Credits to emacs-solo and daviwil
...
**** COMMENT language tool as linter
