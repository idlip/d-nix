...
binds {
  ...
  Mod+Shift+p     { move-window-up-or-to-workspace-up; }
	...
	Mod+braceleft     { focus-monitor-left; }
	Mod+braceright     { focus-monitor-right; }
...
- Gotta try out [[https://github.com/positron-solutions/dslide][dslide]] package sometime
  #+name: orgmacs
  #+begin_src emacs-lisp
  (use-package org-present :defer t :unless d/on-droid :after org
