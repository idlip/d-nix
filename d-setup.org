...
#+begin_src conf :noweb-ref niri-config :tangle ~/.config/niri/config.kdl
  ...
  spawn-at-startup "swayidle -w timeout 150 'brightnessctl -s set 5%' resume 'brightnessctl -r' timeout 180 'noctalia-shell ipc call lockScreen toggle' timeout 200 'niri msg action power-off-monitors' resume 'niri msg action power-on-monitors' timeout 900 'systemctl suspend'"
  ...
  binds {
    ...
    // Bindings should be sensible as in Emacs, and vim (just hjkl)
  	...
  	Mod+X {spawn-sh "noctalia-shell ipc call powerPanel toggle"; }
  	Mod+Y {spawn-sh "d-clip"; }
  	...
  	Mod+o {spawn "d-stuff"; }
    Mod+b { spawn-sh "noctalia-shell ipc call sidePanel toggle"; }
