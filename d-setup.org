...
- The best of all worlds, keyboard driven, API to play with and firefox!
  ...
  #+begin_src nix :tangle foss/pkgs/glide.nix
    { lib, stdenv, fetchurl,
...
#+begin_src typescript :tangle ~/.config/glide/glide.ts
  ...
  function setupPrefs() {
    const prefs: Record<string, any> = {
      ...
      "font.name.monospace.x-western": "Ioskeley Mono",
...
#+begin_src conf :noweb-ref mango :tangle ~/.config/mango/config.conf
  ...
  monitorrule=eDP-1,0.55,1,tile,0,1.25,0,0,1920,1200,60
  monitorrule=HDMI-A-1,0.55,1,tile,0,1.5,1926,0,3840,2160,60
