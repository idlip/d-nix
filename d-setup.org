...
- Imported from prot emacs config
      ...
      programs.qutebrowser = {
        ...
        greasemonkey = [
          ...
          (pkgs.fetchurl {
            ...
            sha256 = "sha256-znsDQ7wWXzhxvE0tM/OeOZrV03y1/MwfpmWrTfOXEh0=";
          })
          (pkgs.fetchurl {
            url = "https://update.greasyfork.org/scripts/423851/Simple%20YouTube%20Age%20Restriction%20Bypass.user.js";
            sha256 = "sha256-qifRTRJhiGPRzPgSt0uPEJ1NCEWA5V3nnM+fnrWFt5o=";
          })
          (pkgs.fetchurl {
          ...
          (pkgs.fetchurl {
            ...
            sha256 = "sha256-dd33OqfDz5fhimldEi6MgVX84vvzB6KrrGMAhuyAQJc=";
          })
...
#+name: qute-redirect
  #+begin_src js
    ...
    //      'from': 'to',
            ...
            '^(?:https?://)(?:www.)?reddit.com': 'http://127.0.0.1:8080',
            '^(?:https?://)(?:www.)?old.reddit.com': 'https://libreddit.kavin.rocks',
        };
