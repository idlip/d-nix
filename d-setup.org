...
#+begin_src typescript :tangle ~/.config/glide/glide.ts
  ...
  function setupKeymaps() {
    ...
    glide.keymaps.set(["normal", "visual"], "<A-v>", "scroll_page_up");
    glide.keymaps.set(["normal", "visual"], "<C-v>", "scroll_page_down");
  ...
  function setupAutocommands() {
    ...
    glide.autocmds.create("ModeChanged", "*", (args) => {
      ...
      glide.styles.add(
        `#browser { border-bottom: 3px solid var(${mode_colors[args.new_mode] ?? fallback}) }`,
...
#+begin_src conf :noweb-ref mango :tangle ~/.config/mango/config.conf
  ...
  animation_curve_focus=0.16,1.0,0.3,1.0
  animation_curve_opafadein=0.16,1.0,0.3,1.0
  animation_curve_opafadeout=0.16,1.0,0.3,1.0
  ...
  bind=SUPER,Delete, spawn, noctalia-shell ipc call screenRecorder toggle
